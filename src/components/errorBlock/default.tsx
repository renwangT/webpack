    ...
    <>
      ...
      >
        <defs>
          ...
          <circle id="error-block-image-default-d" cx="18.823" cy="18.823" r="18.823"></circle>
          <rect
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g transform="rotate(-90 102.429 55.357)">
            ...
            <mask id="error-block-image-default-c" fill="#fff">
              <use xlinkHref="#error-block-image-default-b"></use>
            </mask>
            <use fill="#377EFF" xlinkHref="#error-block-image-default-b"></use>
            <path
          ...
          <g transform="translate(132.857 124)">
            <mask id="error-block-image-default-e" fill="#fff">
              <use xlinkHref="#error-block-image-default-d"></use>
            </mask>
            <use fill="#FBBE47" fillRule="nonzero" xlinkHref="#error-block-image-default-d"></use>
            <circle
              fill="#FFCD6B"
              fillRule="nonzero"
